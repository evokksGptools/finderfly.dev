	...
	<div class="row">
		...
		<div class="bottom-padding col-sm-12 col-md-12">
			...
			<p>
				...
				O FinderFly, de forma alguma, apresenta falta de entendimento do cliente, pois em nossa plataforma você recebe relatórios minuciosos, possibilitando sua melhor intervenção nesse mercado.<br><br>
